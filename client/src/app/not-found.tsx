...
export default function NotFound() {
  return (
    <>
      <div className="z-1 m-auto flex min-h-screen items-center justify-center overflow-hidden p-6">
        {/* <GridShape /> */}
        <div className="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
          <h1 className="text-title-md xl:text-title-2xl mb-8 text-4xl font-bold text-gray-800 dark:text-white/90">
            ERROR
          </h1>
